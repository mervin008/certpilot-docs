...
<!-- Synced from docs/architecture.md in the CertPilot repository by
...
[`core/store/store.go`](https://github.com/certpilot/certpilot/blob/main/core/store/store.go) declares 147 methods.
...
[`core/store/conformance_test.go`](https://github.com/certpilot/certpilot/blob/main/core/store/conformance_test.go) exists.
...
One binary, [`core/cmd`](https://github.com/certpilot/certpilot/blob/main/core/cmd). It serves the REST API and runs every
...
[`core/events`](https://github.com/certpilot/certpilot/blob/main/core/events) is in-process pub/sub. Producers publish; the
